function varargout = GUI_PROJ2(varargin)
% GUI_PROJ2 MATLAB code for GUI_PROJ2.fig
%      GUI_PROJ2, by itself, creates a new GUI_PROJ2 or raises the existing
%      singleton*.
%
%      H = GUI_PROJ2 returns the handle to a new GUI_PROJ2 or the handle to
%      the existing singleton*.
%
%      GUI_PROJ2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_PROJ2.M with the given input arguments.
%
%      GUI_PROJ2('Property','Value',...) creates a new GUI_PROJ2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_PROJ2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_PROJ2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_PROJ2
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GUI_PROJ2_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_PROJ2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_PROJ2 is made visible.
function GUI_PROJ2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_PROJ2 (see VARARGIN)
